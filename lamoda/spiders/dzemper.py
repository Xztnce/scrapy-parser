...
class DzemperSpider(scrapy.Spider):
    name = 'dzemper'
    allowed_domains = ['lamoda.ru']
    start_urls = ['https://www.lamoda.ru/c/6074/clothes-zhentrikotazhzhilety/?page=1']

    pages = 9

    def start_requests(self):
        for page in range(1, 1 + self.pages):
            url = f'https://www.lamoda.ru/c/6074/clothes-zhentrikotazhzhilety/?page={page}'
